...
constexpr std::array<DoorHelp, static_cast<size_t>(DoorHelpTopic::Count)> HELP{{
   ...
   {"Player preferences", "Getting started", Category::GettingStarted,
    "Player Preferences stores presentation choices for this local BBS identity on later calls. The default help level controls what appears when you press ?. Beginner mode explains the game idea behind a screen; Expert mode concentrates on fields, actions, and consequences.\n\nAutomatic page pauses keep long output from scrolling past. You may durably disable them when your terminal or BBS keeps a usable scrollback. This does not skip menus, decisions, confirmations, or other input the game actually requires. Neither preference changes your captain, difficulty, or permissions.",
    "Set the durable Beginner/Expert help default and enable or disable automatic continuation pauses for this BBS identity. Disabling pauses does not bypass menus or confirmations. These local presentation settings have no gameplay effect."},
