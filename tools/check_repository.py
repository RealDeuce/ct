...
def main() -> int:
    ...
    compatibility_checks = [
        ("server/src/wire.rs", r"pub const PROTOCOL_VERSION: u16 = 5;", "CT-RPC version 5"),
        ...
        ("client/src/protocol.cpp", r"constexpr uint16_t PROTOCOL_VERSION = 5;", "CT-RPC version 5"),
