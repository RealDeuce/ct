...
def main() -> int:
    ...
    compatibility_checks = [
        ("server/src/wire.rs", r"pub const PROTOCOL_VERSION: u16 = 9;", "CT-RPC version 9"),
        ...
        ("client/src/protocol.cpp", r"constexpr uint16_t PROTOCOL_VERSION = 9;", "CT-RPC version 9"),
