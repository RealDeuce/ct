...
| 2026-08-27 | Jump traffic uses separate conventional loci on opposite sides of the system ecliptic: departures north and arrivals south. Either locus is a legal maneuver destination and interception-watch station; using the wrong published lane for departure or arrival is allowed with a traffic warning. A filed Jump selects standard inbound arrival, outbound departure-locus arrival, or a seeded private off-lane arrival and may approach port or hold after breakout. Private arrival skips the ordinary arrival-locus contact but adds standoff distance; port contact and high-law mandatory inspection still apply at docking. Onboard fuel processing accepts 0.001-ton batches, remains a stationary Flight Plan action, and may be inserted before retained future route items. CT-RPC 10 ships with v0.7.14; Flight Plan codec 6, ship codec 4, interception-watch codec 3, and the later retained-outcome codec persist the new state. | Current |
