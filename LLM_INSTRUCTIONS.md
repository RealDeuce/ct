...
`docs/ship-family-grouping.md`: 214 designs form 114 families,
...
and manufacturers, all 114 families, and all 214 fitted designs. Names use
...
| 2026-07-27 | The Clement/Earth ship conversion is complete: all reserved identities `ship-1` through `ship-191` are active rule-derived, PI-free catalog entries, with 23 supplemental/core and original designs at `ship-192` through `ship-214`. The closed-content inventory row is an independent generic-rules replacement. Exact catalog status and recurring corrections are recorded in `docs/ship-catalog-conversion-status.md`. | Current |
