...
| 2026-08-24 | BBS-polity generation version 3 considers eligible existing unvisited, unaligned, inhabited frontier systems in Sol's J-2 component as inward polity members, with the version-2 external-anchor form retained as a fallback. When reused, a system's immutable seed, celestial details, and names remain unchanged while its polity affiliation changes; only the other nine invariant members and the outward stub are newly generated. Straight and lateral templates compete in closest-fit ordering. The founding contact's shortest plotted J-2 route to Sol remains the visited bridge, and persisted version-1 and version-2 homes remain historical state. | Current |
